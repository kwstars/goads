...
<!--
example:
    The event interface should be added to GoADS. The interface should contain subscribers and publishers, and the message body should contain key value head
-->
### References
<!--
example:
